...
workflow {
    ...
    // Todas las configuraciones de encoders
    ...
    // Configuraciones únicas de patch_size, mag, batch_size, overlap
    ...
    preprocessing(unique_configs, dataset, wsi_dir, trident_dir)
